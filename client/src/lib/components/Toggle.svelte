...
<div class="flex items-center gap-2 {extraClass}">
  ...
  <!-- The toggle switch -->
  <div class="group relative inline-flex h-5 w-10 shrink-0 cursor-pointer items-center justify-center rounded-full has-focus-visible:outline-2 has-focus-visible:outline-offset-2 has-focus-visible:outline-purple-500 dark:has-focus-visible:outline-purple-500">
    <!-- Background -->
    <span class="absolute mx-auto h-4 w-9 rounded-full bg-gray-200 transition-colors duration-200 ease-in-out group-has-checked:bg-purple-600 dark:bg-gray-700 dark:group-has-checked:bg-purple-500"></span>
    <!-- Knob -->
