...
<Dialog bind:this={dialog} title="Kontakt" icon="envelope-at" closeOnClickOutside class="max-w-2xl">
  <div class="space-y-6">
    <p>
      ...
      <a class="text-purple-400 hover:text-purple-300 font-medium underline" target="_blank" href="https://github.com/mediathekview/mediathekviewweb/issues" onclick={() => trackEvent('Click GitHub Link (Contact-Dialog)')}>Issues auf GitHub</a>.
    </p>
    <p>
      Für fehlende Sendungen gibt es Hilfe
      <a class="text-purple-400 hover:text-purple-300 font-medium underline" target="_blank" href="https://forum.mediathekview.de/" onclick={() => trackEvent('Click Forum Link (Contact-Dialog)')}>im Forum</a>.
    </p>
    <div>
